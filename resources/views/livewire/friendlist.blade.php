        ...
        <ul class="friend-list">
            ...
            <li class="friend">
                ...
                <div style="margin-left: auto; width : 165px; min-width : 165px;">
                    ...
                    <a class="chat-btn" href="/conversation/{{ $list->session_id }}">Chat
        ...
        <ul class="friend-list">
            ...
            <li class="friend">
                ...
                <div style="margin-left: auto; width : 165px; min-width : 165px;">
                    ...
                    <tr>
                        <td>
                            <span style="color : #929693; font-size : 12px;margin-right : 10px;">
        ...
        <ul class="friend-list">
            ...
            <li class="friend">
                ...
                <div style="margin-left: auto; width : 165px; min-width : 165px;">
                    ...
                    <tr>
                        <td>
                            <svg style="color : #929693; margin-right : 5px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-snow-fill" viewBox="0 0 16 16">
                        ...
                        <td>
                            <span style="color : #929693; font-size : 12px;margin-right : 10px;">deactivated</span>
                        </td>
                    </tr>
                    </table>
                </div>
