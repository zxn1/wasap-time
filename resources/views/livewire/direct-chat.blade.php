...
<body>
    ...
    @forelse($messageChats as $chat)     
        ...
        {
            $message_received = $rsa_member->decrypt($chat->chat_message);
            ...
            <div class="message received">
                ...
                <img
                src="https://api.dicebear.com/6.x/bottts-neutral/svg?seed=Bob"
                alt="avatar" />
                </div>
                <div class="text" style="background-color :#e0e0ca">
                    <span style="font-size : 11px;">{!! '@' !!}Sifuu Bot
                        <svg class='mb-1' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-robot" viewBox="0 0 16 16">
                    ...
                    <p><?php echo str_replace('###@$AI_SIFUU_300#@$###:', '', $message_received); ?></p>
        ...
        @else
		<?php
        $message_sended = $rsa_self->decrypt($chat->chat_message);
        if(strpos($message_sended, '###@$AI_SIFUU_300#@$###:') !== false)
        {
        ?>
        <div class="message received">
            <div class="avatar" style="overflow : hidden;">
            ...
            <div class="text" style="background-color :#e0e0ca">
                ...
                <p><?php echo str_replace('###@$AI_SIFUU_300#@$###:', '', $message_sended); ?></p>
                <div class="time">{{ $chat->created_at }}</div>
            </div>
        </div>
        <?php
    ...
    <div class="chat-input-holder">
        <div class="chat-input">
            <button wire:click='botInProgress' class="<?php if($botActivate == false) { echo 'bot-deactive-button'; } else { echo 'bot-active-button'; } ?>">
