...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">Wasap</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="/">Home (Room)</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/conversation">Chat</a></li>
                                <li><a class="dropdown-item" href="/list">Find Friends</a></li>
                                <li><a class="dropdown-item" href="http://198.98.57.19:83/davinci" target="_blank">
                                ...
                                <li><a class="dropdown-item" href="https://www.buymeacoffee.com/milcennii">Buy me a coffee
                                ...
                                <li><a class="dropdown-item" {{ ''/*href="https://github.com/zxn1/wasap-time" */ }}>Get the code (Github)
